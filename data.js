window.OBSIDIAN_DATA = {
 ...
 "generatedTime": "2026-08-01 01:06",
 "rootTitle": "徐总的知识库",
 "weeklyPages": 32,
 "weeklyChanges": 449,
 ...
 "today": {
  ...
  "items": [
   ...
   },
   {
    ...
    "summary": "企业 AI 定制短期不赚钱、客户真实付费集中在可见 ROI 业务、AI 落地最大成本是改变工作习惯、老板比员工更可能高频使用 AI、AI 翻译官比单纯 AI 工",
    "points": [
   ...
   },
   {
    ...
    "summary": "生产级 Agent 工程架构不是让 AI 直接全自动设计，而是由 FDE 决定阶段边界、架构深度、人审位置、权限审计、状态机颗粒度和验收标准，AI 负责生成候选",
    "points": [
     "来源层级：正式工程框架页新增判断。",
