window.OBSIDIAN_DATA = {
 ...
 "generatedTime": "2026-08-03 15:45",
 "rootTitle": "徐总的知识库",
 "weeklyPages": 81,
 "weeklyChanges": 825,
 "sourceIndex": "知识库索引.md",
 "digest": "知识流水线/每日学习整理/2026-08-02｜AI知识增量整理.md",
 "topics": [
  {
   "name": "AI Agent工程知识",
   "key": "agent",
 ...
 "questionTopics": [
  {
   ...
   "distillItems": [],
   "nextQuestions": [
    "庆阳基地实际可对接的产能方（哪些上市公司/国资在运营）？",
    "厦门 Token 工厂服务联盟准入条件（需要什么资质）？",
    "三大运营商 Token 聚合平台的开放策略（集成商怎么接入）？",
    "FDE/集成商在 AaaS 层做垂直封装的真实案例？",
    "海外目标市场（东南亚/金砖）当前的 AI 落地节奏？",
    "徐总自己的角色定位是什么 → 决定走哪条分叉路径"
   ],
   "links": [
    "AI产业链与数字基础设施/甘肃庆阳AI算力产业崛起与Token工厂",
    "AI产业链与数字基础设施/AI基础设施发展路径：从服务器到智算中心再到AI算力网络",
